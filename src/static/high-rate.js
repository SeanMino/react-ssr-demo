!function () {
  var a = "@charset \"utf-8\";html{color:#000;background:#fff;overflow-y:scroll;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%}html *{outline:0;-webkit-text-size-adjust:none;-webkit-tap-highlight-color:rgba(0,0,0,0)};h1,h2,h3,h4,h5,h6{font-size:100%;font-weight:500}q:before,q:after{content:''}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sup{top:-.5em}sub{bottom:-.25em}", b = document.createElement("style");
...
!function (a, b) {
  ...
  }, !1), "complete" === e.readyState ? e.body.style.fontSize = 20 * i + "px" : e.addEventListener("DOMContentLoaded", function () {
      e.body.style.fontSize = 20 * i + "px"
