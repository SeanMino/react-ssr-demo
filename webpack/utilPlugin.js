...
function UtilPlugin(options) {
  ...
  this.copyFiles = options.copyFiles || [];
}
...
UtilPlugin.prototype.apply = function (compiler) {
  ...
  compiler.plugin('done', function () {
    _this.copy.forEach(function (f) {
      var fromPath = path.resolve(_this.base, f.from), toPath = path.resolve(_this.base, f.to);
      FsUtil.copyDir(fromPath, toPath);
    });
    _this.copyFiles.forEach(function (f) {
      var fromPath = path.resolve(_this.base, f.from), toPath = path.resolve(_this.base, f.to);
      FsUtil.copyFile(fromPath, toPath);
    });
